...
# Where is your data?
When working with data, it is helpful to keep everything in one place. For this course, we will create nested folders to keep track of our data from the Open University. In my user directory, I created a folder called "Data" and in that folder I created a folder "OULAD." I access my data using "~/Data/OULAD/." For for information on importing and exporting data using R see <http://r4ds.had.co.nz/data-import.html#data-import>.

Now that all of our data is in a folder that we can find with regularity, explore each file to get a feel for what is there. I have included descriptions of each file in this R Markdown file from <https://analyse.kmi.open.ac.uk/open_dataset>.
